 ...
 * 
 * Displays a paginated grid of activity cards with sorting capabilities.
 * Similar to the Activities component but structured specifically for list views.
 * 
 * Features:
 * - Sort activities by different metrics
 * - Paginate through activity cards
 * - Open detailed view of individual activities
 */
